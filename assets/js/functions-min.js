!function(t, e, i, n) {
    ...
    function d(t, e, i) {
        o(m(e), function(e) {
            t.addEventListener(e, i, { passive: false })
        })
    }
    function p(t, e, i) {
        o(m(e), function(e) {
...
$(document).ready(function() {
    ...
    function n() {
        $(".header--nav-toggle").click(function() {
            ...
            $(".outer-nav, .outer-nav li, .outer-nav--return").addClass("is-vis") //选择出现
        }),
        $(".outer-nav--return").click(function() {
            $(".perspective").removeClass("effect-rotate-left--animate");  //返回之前的状态
            setTimeout(function() {
                $(".perspective").removeClass("perspective--modalview");
            }, 400);

            $(".outer-nav, .outer-nav li, .outer-nav--return").removeClass("is-vis")  //选择地方消失
        })
